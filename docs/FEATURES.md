...
- ✅ **Araç merdiveni**: her stat kendi sayacını tutar, `750 × 1.5^tamamlanan` RP ve `6 sa × 1.5^n` (**22 sa tavanlı**) süre. Adım başına +6 stat. **Hiçbir iş 22 saati aşmaz** (OSM tarzı günlük döngü: yatmadan başlatılan iş ertesi akşam yarıştan önce hazır). Süre tavanlanır, **fiyat tavanlanmaz** — geç sezonda fren tamamen parasal olur
- ✅ **Üç tezgah, gruplar arası paralel / grup içinde tek**: araç (MOTOR+AERO+GRIP tek tezgahı paylaşır), sürücü (kadronun tamamı tek antrenman koltuğunu paylaşır, 6 sa), istihbarat (casus görevi 22 sa, sonraki görev 22 sa sonra)
...
- ✅ **Denge kapısı**: `npm run econ` (`scripts/econ-check.ts`) — 67 kontrol, sezon simülasyonu dahil. Yalın kadro sezonu 91/88/90 (ort 89.7), P3, 12 geliştirme ile bitirir; elit kadro 22 puan geride kalır
...
- ✅ Casusluk: hedef takım + stat; ücretsiz ajan (%55 başarı, %12 yakalanma) / profesyonel (15 Altın ya da 900 RP, %85, yakalanmaz); **rapor 22 gerçek saat sonra**, sonraki görev 22 saat sonra, 110 Altınla hemen alınabilir; başarı → sonraki geliştirme ×1.5, yanlış istihbarat ×0.5, yakalanma → RP cezası + hedefe güç
