...
- ✅ **Dürüst doluluk** (§3.4): kartın gösterdiği her sayı gerçek koltuk satırlarından gelir. Dağıtım yalnızca HANGİ gerçek lobinin önerileceğini şekillendirir; sahte kıtlık üretilmez. `npm run sim:matchmaking` bunu ölçer: gerçekçi havuzlarda 3. araç ≥ %85, 4. araç ≥ %75; kıt havuzda hedefin altında kalır ama havuzda var olanı asla aşmaz.
